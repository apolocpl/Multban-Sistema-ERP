                                    ...
                                    <div id="camposParticipante" style="display: none;">
                                        <div class="row">
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="partcp_pvlaor" name="partcp_pvlaor" placeholder="00,00" maxlength="6">
                                    ...
                                    <div id="camposProduto" style="display: none;">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control  form-control-sm" id="produto_peso" name="produto_peso" placeholder="Peso em gr" required >
